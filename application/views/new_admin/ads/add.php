...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title">اضافة إعلان</h4>
	</div>
	<div class="panel-body">
		<div class="container-fluid">
			...
			if($inserted)
			{
				...
				<a href="#" data-dismiss="alert" class="close" rel="close">&times;</a>
				تمت إضافة الإعلان
				<a href="'.$admin_dir.'/'.$this->router->fetch_class().'/add/" class="btn btn-primary btn-xs">إضافة إعلان جديدة</a>
				</div>';
			}
			if($updated)
			{
			...
			<?php if(in_array('title' , $has)){ ?><div class="row">
				<div class="form-group">
					<label for="title" class="col-md-3">اسم الإعلان</label>
					<input type="text" class="form-control col-md-9" name="title" id="title" value="<?php echo $row['title']?>" data-validation="required" data-validation-error-msg="اسم الإعلان" />
				</div>
			</div><?php }?>
		    
		    <div class="row">
				<div class="form-group">
					<label for="content" class="col-md-3">رابط الإعلان</label>
					<input type="text" class="form-control col-md-9"
					name="content" id="content"
						value="<?php echo $row['content']?>"
						data-validation="required" data-validation-error-msg="الرابط" />
				</div>
			</div>
		    <div class="row">
				<div class="form-group">
