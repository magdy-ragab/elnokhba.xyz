...
<div class="table-responsive">
	...
	<thead>
		...
		<th class="col-xs-7">العنوان</th>
		<th class="col-xs-2">عدد المنتجات</th>
	...
	<tbody>
		...
		?>
    		...
    		<td> <a href="<?= $admin_dir . "/" . $cont . "/prod/{$row->ID}" ?>"><span class="badge badge-info">
				<?php echo $this->db->where("`promotion`='{$row->ID}'")->get("promotion_product")->num_rows() ?></span></a>
    		</td>
